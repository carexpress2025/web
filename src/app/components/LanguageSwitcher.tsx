...
export default function LanguageSwitcher() {
  ...
  const languages = [
    { code: 'en', label: t('sidebar.languages.en_US') },
    { code: 'fi', label: t('sidebar.languages.fi_FI') },
    { code: 'br', label: t('sidebar.languages.pt_BR') },
  ];

  return (
    <div className="flex items-center justify-between w-full p-2 rounded-md bg-gradient-to-r from-gray-400 to-gray-600">
      <span className="text-sm text-gray-800">{t('sidebar.language')}</span>
      <select
